        ...
        /***/ (function (__unused_webpack_module, exports) {
            ...
            var NodeType = /** @class */ (function () {
                ...
                NodeType.define = function (spec) {
                    ...
                    if (spec.props)
                        for (var _i = 0, _b = spec.props; _i < _b.length; _i++) {
                            var src = _b[_i];
                ...
                NodeType.match = function (map) {
                    ...
                    for (var prop in map)
                        for (var _i = 0, _b = prop.split(" "); _i < _b.length; _i++) {
                            var name_4 = _b[_i];
                            direct[name_4] = map[prop];
                        }
        ...
        /***/ (function (__unused_webpack_module, exports, __webpack_require__) {
            ...
            var Parse = /** @class */ (function () {
                ...
                Parse.prototype.runRecovery = function (stacks, tokens, newStacks) {
                    ...
                    for (var i = 0; i < stacks.length; i++) {
                        ...
                        for (var _i = 0, _b = stack.recoverByInsert(token); _i < _b.length; _i++) {
                            var insert = _b[_i];
                            if (verbose)
                    ...
                    if (finished)
                        return finished;
                    if (maybeNest)
                        for (var _c = 0, _d = this.stacks; _c < _d.length; _c++) {
                            var s = _d[_c];
            ...
            var Parser = /** @class */ (function () {
                ...
                function Parser(spec) {
                    ...
                    if (spec.nodeProps)
                        for (var _i = 0, _b = spec.nodeProps; _i < _b.length; _i++) {
                            var propSpec = _b[_i];
                            var prop = propSpec[0];
                ...
                Parser.prototype.parseDialect = function (dialect) {
                    ...
                    if (dialect)
                        for (var _i = 0, _b = dialect.split(" "); _i < _b.length; _i++) {
                            var part = _b[_i];
